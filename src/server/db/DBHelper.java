...
public class DBHelper {
    ...
    private static final String URL = "jdbc:mysql://***.*.*.*/quarto_db";   //Change here ***...
    private static final String USER = "****";  //Change here ***...
    private static final String PASSWORD = "*********"; //Change here ***...
